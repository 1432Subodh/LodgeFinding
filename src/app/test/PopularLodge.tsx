...
const popularLodges: PopularLodgeProps[] = [
  {
    ...
    description:
      "Luxurious cabin with panoramic mountain views and direct access to ski slopes.",
  },
  {
    id: 2,
    ...
    description:
      "Spectacular oceanfront property with private beach access and stunning sunset views.",
  },
  {
    id: 3,
    ...
    description:
      "Unique elevated living experience surrounded by ancient redwoods and natural beauty.",
  },
];
...
export default function PopularLodge() {
  ...
  const handlePrev = () => {
    setActiveIndex((prev) =>
      prev === 0 ? popularLodges.length - 1 : prev - 1
    );
  };
  ...
  useEffect(() => {
    console.log("Fetching popular lodges...");
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-5 w-full max-w-7xl">
          ...
          <div className="flex flex-col justify-center h-full p-6 md:p-12 dark:bg-zinc-900 bg-zinc-100 rounded-2xl shadow-lg">
            <div className="mb-2 flex items-center justify-between">
              <span className="text-sm uppercase tracking-wider text-gray-500 dark:text-gray-200 font-medium">
                Featured Lodge
              </span>
            ...
            <h3 className="sm:text-3xl text-xl font-bold  mb-1">
              {activeLodge.name}
            </h3>
            ...
            <p className="text-gray-700 dark:text-gray-400 mb-3">
              {activeLodge.description}
            </p>

            <div className="mb-4">
              <h4 className="font-semibold text-gray-900 dark:text-gray-400 mb-3">
                Amenities
              </h4>
